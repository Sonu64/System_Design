...
*/
abstract class Car_main {
    protected String brand;
    protected String model;
    protected boolean isEngineOn;
    protected int currentSpeed;

    public Car_main(String brand, String model) {
        this.brand = brand;
        this.model = model;
...
class Manual_Car extends Car_main {
...
class Electric_Car extends Car_main {
    private int batteryLevel;

    public Electric_Car(String brand, String model) {
        super(brand, model);
...
public class Dynamic_RUNTIME_Polymorphism {
    public static void main(String[] args) {
        Car_main myManualCar = new Manual_Car("Suzuki", "WagonR");
        ...
        Car_main myElectricCar = new Electric_Car("Tesla", "Model S");
